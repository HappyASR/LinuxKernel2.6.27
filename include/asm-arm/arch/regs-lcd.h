...
#define SOCLE_LCD_BASE			IO_ADDRESS(SOCLE_AHB0_LCD)

/* LCD control registers */
#define SOCLE_LCD_CTRL0				(SOCLE_LCD_BASE + 0x00)
#define SOCLE_LCD_CTRL1				(SOCLE_LCD_BASE + 0x04)
#define SOCLE_LCD_YUV2RGB_CTRL			(SOCLE_LCD_BASE + 0x08)
#define SOCLE_LCD_H_TIMING			(SOCLE_LCD_BASE + 0x10)
#define SOCLE_LCD_V_TIMING			(SOCLE_LCD_BASE + 0x14)
#define SOCLE_LCD_STN_TIMING		(SOCLE_LCD_BASE + 0x18)
#define SOCLE_LCD_LUT_ADDR			(SOCLE_LCD_BASE + 0x1C)
#define SOCLE_LCD_PAGE0_ADDR		(SOCLE_LCD_BASE + 0x20)
#define SOCLE_LCD_PAGE1_ADDR		(SOCLE_LCD_BASE + 0x24)
#define SOCLE_LCD_LPAGE0_ADDR		(SOCLE_LCD_BASE + 0x28)
#define SOCLE_LCD_LPAGE1_ADDR		(SOCLE_LCD_BASE + 0x2C)
#define SOCLE_LCD_INTR_STS			(SOCLE_LCD_BASE + 0x40)
#define SOCLE_LCD_INTR_EN			(SOCLE_LCD_BASE + 0x44)
#define SOCLE_LCD_INTR_DIS			(SOCLE_LCD_BASE + 0x48)
#define SOCLE_LCD_INTR_MASK		(SOCLE_LCD_BASE + 0x4C)
#define SOCLE_LCD_Y_PAGE0_ADDR			(SOCLE_LCD_BASE + 0x50)
#define SOCLE_LCD_Cb_PAGE0_ADDR			(SOCLE_LCD_BASE + 0x54)
#define SOCLE_LCD_Cr_PAGE0_ADDR			(SOCLE_LCD_BASE + 0x58)
#define SOCLE_LCD_Y_PAGE1_ADDR			(SOCLE_LCD_BASE + 0x60)
#define SOCLE_LCD_Cb_PAGE1_ADDR			(SOCLE_LCD_BASE + 0x64)
#define SOCLE_LCD_Cr_PAGE1_ADDR			(SOCLE_LCD_BASE + 0x68)
#define SOCLE_LCD_INTR_VER			(SOCLE_LCD_BASE + 0xFC)
