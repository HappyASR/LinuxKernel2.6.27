/* linux/include/asm/arch-socle/regs-pc9220-scu.h
 *
...
#ifndef __SOCLE_PC9220_SCU_H
#define __SOCLE_PC9220_SCU_H                     1
...
#if 0
//XIN 12.288MHz
#define SCU_CPU_CLOCK_33	SCU_CLOCK_REG	(30, 332, 3)
#define SCU_CPU_CLOCK_66	SCU_CLOCK_REG	(30, 332, 1)
#define SCU_CPU_CLOCK_80	SCU_CLOCK_REG	(31, 624, 2)
#define SCU_CPU_CLOCK_100	SCU_CLOCK_REG	(28, 471, 1)
#define SCU_CPU_CLOCK_132	SCU_CLOCK_REG	(26, 289, 0)
#define SCU_CPU_CLOCK_133	SCU_CLOCK_REG	(16, 183, 0)
#define SCU_CPU_CLOCK_166	SCU_CLOCK_REG	(35, 1458, 2)
#define SCU_CPU_CLOCK_200	SCU_CLOCK_REG	(10, 178, 0)
#define SCU_CPU_CLOCK_240	SCU_CLOCK_REG	(31, 624, 0)
#define SCU_CPU_CLOCK_258	SCU_CLOCK_REG	(0, 20, 0)
#define SCU_CPU_CLOCK_264	SCU_CLOCK_REG	(32, 708, 0)
#define SCU_CPU_CLOCK_266	SCU_CLOCK_REG	(16, 367, 0)
#define SCU_CPU_CLOCK_280	SCU_CLOCK_REG	(13, 318, 0)
#define SCU_CPU_CLOCK_300	SCU_CLOCK_REG	(11, 292, 0)
#define SCU_CPU_CLOCK_320	SCU_CLOCK_REG	(23, 624, 0)
#define SCU_CPU_CLOCK_340	SCU_CLOCK_REG	(2, 82, 0)
#define SCU_CPU_CLOCK_350	SCU_CLOCK_REG	(24, 711, 0)
#define SCU_CPU_CLOCK_360	SCU_CLOCK_REG	(9, 292, 0)
#define SCU_CPU_CLOCK_400	SCU_CLOCK_REG	(8, 292, 0)
#else
//XIN 12MHz
...
#define SCU_MCLK_UHC0			(1<<21)
#define SCU_MCLK_UDC			(1<<20)
#define SCU_MCLK_UHC1			(1<<19)
...
#define SCU_ACLK_UDC_HARDMACRO	(1<<17)
#define SCU_ACLK_MPLL_OSC_CRYSTAL	(1<<16)
#define SCU_ACLK_MPLL_OSC_CLK		(1<<15)
#define SCU_ACLK_ST_SDR			(1<<14)
#define SCU_ACLK_HS_UART			(1<<13)
#define SCU_ACLK_LCD_VOP			(1<<11)
#define SCU_ACLK_MAC				(1<<10)
#define SCU_ACLK_UHC0				(1<<9)
#define SCU_ACLK_UHC1				(1<<8)
#define SCU_ACLK_UTMI_UHC1		(1<<7)
#define SCU_ACLK_UTMI_UHC0		(1<<6)
#define SCU_ACLK_UDC				(1<<5)
...
#define SCU_PWMCON_USB_MODE			(1<<8)	
#define SCU_PWMCON_USB_MODE_UDC		(1<<8)	
#define SCU_PWMCON_USB_MODE_UHC		0		
...
#define SCU_PWMCON_BOOT_FAIL			(1<<3)		
...
#define SCU_DEVCON_UHC0_48CLK_UPLL		(1<<29)
#define SCU_DEVCON_UHC0_48CLK_OTGPHY	0
#define SCU_DEVCON_UHC1_48CLK_UPLL		(1<<28)
#define SCU_DEVCON_UHC1_48CLK_OTGPHY	0
