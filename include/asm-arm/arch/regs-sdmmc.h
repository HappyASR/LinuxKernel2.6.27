...
#define SOCLE_SDMMC_MMU_DMA_TX_SIGNAL_END 0x0 /* MMU DMA transfer end */
#define SOCLE_SDMMC_MMU_DMA_TX_SIGNAL_BEGIN (0x1 << 11) /* MMU DMA transfer begin */

/* MMU DMA transfer direction */
#define SOCLE_SDMMC_MMU_DMA_TX_DIR_READ 0 /* MMU DMA transfer direction is read */
#define SOCLE_SDMMC_MMU_DMA_TX_DIR_WRITE (0x1 << 10) /* MMU DMA transfer direction is write */
...
#define SOCLE_SDMMC_MMU0_BUS_CTRL_DATABUF_2 (0x1 << 9) /* the MMU1 bus control data buffer2 and the MMU1 bus control data buffer1 */
...
#define SOCLE_SDMMC_DATABUF_2_TX_WIDTH_BYTE 0x0 /* data buffer2 transfer width is byte */
#define SOCLE_SDMMC_DATABUF_2_TX_WIDTH_HALFWORD (0x1 << 4) /* data bufffer2 transfer width is halfword */
#define SOCLE_SDMMC_DATABUF_2_TX_WIDTH_WORD (0x3 << 4) /* data buffer2 transfer width is word */
...
#define SOCLE_SDMMC_DATABUF_1_TX_WIDTH_BYTE 0x0 /* data buffer1 transfer width is byte */
#define SOCLE_SDMMC_DATABUF_1_TX_WIDTH_HALFWORD 0x1 /* data buffer1 transfer width is halfword */
#define SOCLE_SDMMC_DATABUF_1_TX_WIDTH_WORD 0x3 /* data buffer1 transfer width is word */

#define SOCLE_SDMMC_MMU_DATA_WIDTH_BYTE (SOCLE_SDMMC_MMU_DMA_TX_SIGNAL_END | \
					 SOCLE_SDMMC_MMU_DMA_TX_DIR_READ | \
					 ...
					 SOCLE_SDMMC_DATABUF_2_TX_WIDTH_BYTE | \
					 SOCLE_SDMMC_DATABUF_1_POINTER_RST | \
					 SOCLE_SDMMC_DATABUF_1_POINTER_END_SIGNAL_LOW | \
					 SOCLE_SDMMC_DATABUF_1_TX_WIDTH_BYTE)
#define SOCLE_SDMMC_MMU_DATA_WIDTH_HALFWORD (SOCLE_SDMMC_MMU_DMA_TX_SIGNAL_END | \
					     SOCLE_SDMMC_MMU_DMA_TX_DIR_READ | \
					     SOCLE_SDMMC_MMU0_BUS_CTRL_DATABUF_2 | \
					     SOCLE_SDMMC_HOST_CTRL_DATABUF_1 | \
					     SOCLE_SDMMC_DATABUF_2_POINTER_RST | \
					     ...
					     SOCLE_SDMMC_DATABUF_1_POINTER_RST | \
					     SOCLE_SDMMC_DATABUF_1_POINTER_END_SIGNAL_LOW | \
					     SOCLE_SDMMC_DATABUF_1_TX_WIDTH_HALFWORD)
#define SOCLE_SDMMC_MMU_DATA_WIDTH_WORD (SOCLE_SDMMC_MMU_DMA_TX_SIGNAL_END | \
					 SOCLE_SDMMC_MMU_DMA_TX_DIR_READ | \
					 SOCLE_SDMMC_MMU0_BUS_CTRL_DATABUF_2 | \
					 SOCLE_SDMMC_HOST_CTRL_DATABUF_1 | \
					 SOCLE_SDMMC_DATABUF_2_POINTER_RST | \
					 ...
					 SOCLE_SDMMC_DATABUF_1_POINTER_RST | \
					 SOCLE_SDMMC_DATABUF_1_POINTER_END_SIGNAL_LOW | \
					 SOCLE_SDMMC_DATABUF_1_TX_WIDTH_WORD)
...
#define SOCLE_SDMMC_CMD_RESP_TX_INT_STAT_NO 0x0 /* command and response transfer interrupt status is no */
#define SOCLE_SDMMC_CMD_RESP_TX_INT_STAT_YES (0x1 << 6) /* command and response transfer interrupt status is yes */

/* Data transfer interrupt status */
#define SOCLE_SDMMC_DATA_TX_INT_STAT_NO 0x0 /* data transfer interrupt status is no */
#define SOCLE_SDMMC_DATA_TX_INT_STAT_YES (0x1 << 5) /* data transfer interrupt status is yes */
...
#define SOCLE_SDMMC_CMD_RESP_TX_INT_DIS 0x0 /* disable command and response transfer interrupt */
#define SOCLE_SDMMC_CMD_RESP_TX_INT_EN (0x1 << 2) /* enable command and response transfer interrupt */

/* Data transfer interrupt control */
#define SOCLE_SDMMC_DATA_TX_INT_DIS 0x0 /* disable data transfer interrupt */
#define SOCLE_SDMMC_DATA_TX_INT_EN (0x1 << 1) /* enable data transfer interrupt */
...
/* Card detect signal */
#if defined(CONFIG_ARCH_PDK_PC9002) || defined(CONFIG_ARCH_SCDK) || defined(CONFIG_ARCH_PDK_PC9220)
#define SOCLE_SDMMC_CARD_DETECT_SIGNAL_HIGH 0x0 /* card detect signal is high */
#else
...
#define SOCLE_SDMMC_CMD_TX_SIGNAL_END 0x0 /* command transfer end */
#define SOCLE_SDMMC_CMD_TX_SIGNAL_BEGIN (0x1 << 13) /* command transfer begins */

/* Response transfer signal */
#define SOCLE_SDMMC_RESP_TX_SIGNAL_END 0x0 /* response transfer end */
#define SOCLE_SDMMC_RESP_TX_SIGNAL_BEGIN (0x1 << 12) /* response transfer begins */

/* Response transfer type */
#define SOCLE_SDMMC_RESP_TX_TYPE_R1 0x0	/* response transfer type is R1 */
#define SOCLE_SDMMC_RESP_TX_TYPE_R1B (0x1 << 9) /* response transfer type is R1b */
#define SOCLE_SDMMC_RESP_TX_TYPE_R2 (0x2 << 9) /* response transfer type is R2 */
#define SOCLE_SDMMC_RESP_TX_TYPE_R3 (0x3 << 9) /* response transfer type is R3 */
#define SOCLE_SDMMC_RESP_TX_TYPE_R6 (0x6 << 9) /* response transfer type is R6 */

/* Command and response transfer error status */
#define SOCLE_SDMMC_CMD_RESP_TX_STAT_N_ERR 0x0 /* command and response transfer error status is no error */
#define SOCLE_SDMMC_CMD_RESP_TX_STAT_ERR (0x1 << 8) /* command and response transfer error status is error */
...
#define SOCLE_SDMMC_CARD_CMD_TX_SIGNAL_BEGIN (0x1 << 8) /* card command transfer begins */
#define SOCLE_SDMMC_CARD_RESP_TX_SIGNAL_BEGIN (0x1 << 7) /* card response transfer begins */
...
#define SOCLE_SDMMC_CARD_RESP_TX_BIT_ERR (0x1 << 3) /* card response transmission bit is error */
...
#define SOCLE_SDMMC_DATA_TX_SIGNAL_END 0x0 /* data transfer end */
#define SOCLE_SDMMC_DATA_TX_SIGNAL_BEGIN (0x1 << 13) /* data transfer begins */

/* Data transfer direction */
#define SOCLE_SDMMC_DATA_TX_DIR_READ 0x0 /* data transfer direction is read */
#define SOCLE_SDMMC_DATA_TX_DIR_WRITE (0x1 << 12) /* data transfer direction is write */

/* Data transfer bus width */
#define SOCLE_SDMMC_DATA_TX_BUS_WIDTH_LINE_1 0x0 /* data transfer bus width is line */
#define SOCLE_SDMMC_DATA_TX_BUS_WIDTH_LINE_4 (0x1 << 11) /* data transfer bus width is lines */

/* Data transfer with DMA function */
#define SOCLE_SDMMC_DATA_TX_DMA_DIS 0x0 /* disable data transfer with DMA function */
#define SOCLE_SDMMC_DATA_TX_DMA_EN (0x1 << 10) /* enable data transfer with DMA function */

/* Data transfer cycle */
#define SOCLE_SDMMC_DATA_TX_CYC_SINGLE 0x0 /* data transfer cycle is single */
#define SOCLE_SDMMC_DATA_TX_CYC_MULTIPLE (0x1 << 9) /* data transfer cycle is multiple */

/* Data transfer error */
#define SOCLE_SDMMC_DATA_TX_STAT_ERR (0x1 << 8) /* data transfer error status is error */
#define SOCLE_SDMMC_DATA_TX_BUS_CONFLICT_ERR (0x1 << 7) /* data transfer conflict error is error */
#define SOCLE_SDMMC_DATA_TX_TO_ERR (0x1 << 6) /* data transfer timeout error is error */
#define SOCLE_SDMMC_DATA_TX_CRC_ERR (0x1 << 5) /* data transfer CRC error is error */
#define SOCLE_SDMMC_READ_DATA_TX_STR_BIT_ERR (0x1 << 4) /* read data transfer start bit error is error */
#define SOCLE_SDMMC_READ_DATA_TX_END_BIT_ERR (0x1 << 3) /* read data transfer end bit error is error */
#define SOCLE_SDMMC_WRITE_DATA_TX_CRC_STAT_N_ERR 0x2 /* write data transfer CRC status is no error */
#define SOCLE_SDMMC_WRITE_DATA_TX_CRC_STAT_CRC_ERR 0x5 /* write data transfer CRC status is CRC error */
#define SOCLE_SDMMC_WRITE_DATA_TX_CRC_STAT_NO_RESP 0x7 /* write data transfer CRC status is no response */
