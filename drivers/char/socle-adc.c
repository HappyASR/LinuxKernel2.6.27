...
#define ADCDBUG(fmt, args...) printk( KERN_DEBUG "SQ_ADC : " fmt, ## args)
#else
...
static char __initdata banner[] = "SQ ADC, (c) 2010 SQ Corp. \n";
...
MODULE_DESCRIPTION("SQ ADC Driver");
MODULE_LICENSE("GPL");
