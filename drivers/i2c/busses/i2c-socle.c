...
#include <mach/cheetah-scu.h>//peter + for socle_get_apb_clock
#endif
...
socle_i2c_remove(struct platform_device *pdev)
{
	...
	dev_dbg(&pdev->dev, "sq_i2c_remove()\n");
	if (!host)
		return -1;
...
MODULE_DESCRIPTION("SQ I2C Adaptor/Algorithm Driver");
