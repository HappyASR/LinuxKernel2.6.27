 ...
 *  DAC master volume
 *  */
#define UDA1342TS_FUNC_DAC_MASTER_VOLUME_L(x) (((x) & 0xff) << 8)
#define UDA1342TS_FUNC_DAC_MASTER_VOLUME_R(x) ((x) & 0xff)
#define UDA1342TS_FUNC_DAC_MASTER_VOLUME_L_MASK (0xff << 8)
#define UDA1342TS_FUNC_DAC_MASTER_VOLUME_R_MASK 0xff
...
extern int uda1342ts_dac_reset(void);
extern int uda1342ts_adc_reset(void);
extern int uda1342ts_dac_set_system_frequency(u16 freq);
extern int uda1342ts_adc_set_system_frequency(u16 freq);
extern int uda1342ts_dac_power_switch(int val);
extern int uda1342ts_adc_power_switch(int val);
extern int uda1342ts_dac_tone_switch(int val);
extern int uda1342ts_dac_master_volume_l(int val);
extern int uda1342ts_dac_master_volume_r(int val);
extern int uda1342ts_adc_input_amplifier_gain_channel_1(int val);
extern int uda1342ts_adc_input_amplifier_gain_channel_2(int val);
extern int uda1342ts_dac_tone_bass(int val);
extern int uda1342ts_dac_tone_treble(int val);
extern int uda1342ts_set_input_channel(u32 ch);
