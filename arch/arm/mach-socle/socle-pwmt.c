...
//#define CONFIG_SOCLE_PWMT_DEBUG
	...
	#define PWMT_DBG(fmt, args...) printk(KERN_DEBUG "SQ_PWMT: " fmt, ## args)
#else
...
//static char __initdata banner[] = "SQ PWM Timer, (c) 2007 SQ Corp.\n";
...
//	struct resource *pwmt_resource;
	...
	base = IO_ADDRESS(SOCLE_APB0_PWM);
...
MODULE_DESCRIPTION("SQ PWMT Driver");
MODULE_LICENSE("GPL");
