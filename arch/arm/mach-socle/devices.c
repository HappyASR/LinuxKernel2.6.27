...
#if defined(CONFIG_KEYBOARD_P7DK) || defined(CONFIG_KEYBOARD_P7DK_MODULE)
#include <linux/input.h>
...
static struct resource socle_adc_resource[] = {
	[0] = {
		.start = SOCLE_APB0_ADC,
		.end   = SOCLE_APB0_ADC + SZ_4K -1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_ADC,
...
static struct resource socle_spi0_resources[] = {
	[0] = {
		.start = SOCLE_APB0_SPI0,
		.end = SOCLE_APB0_SPI0 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SPI0,
...
#if (defined(CONFIG_ARCH_CDK) || defined(CONFIG_ARCH_PDK_PC9002) || defined(CONFIG_ARCH_SCDK) || defined(CONFIG_ARCH_PDK_PC9220))
static struct resource socle_spi1_resources[] = {
	[0] = {
		.start = SOCLE_APB0_SPI1,
		.end = SOCLE_APB0_SPI1 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SPI1,
...
static struct resource socle_sdmmc_resources[] = {
	[0] = {
		.start = SOCLE_APB0_SDMMC,
		.end = SOCLE_APB0_SDMMC + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SDMMC,
...
static struct resource socle_sdhc0_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_SDCH0,
		.end = SOCLE_AHB0_SDCH0 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SDCH0,
...
static struct resource socle_sdhc1_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_SDCH1,
		.end = SOCLE_AHB0_SDCH1 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SDCH1,
...
static struct resource socle_pwmt_resource[] = {
	[0] = {
		.start = SOCLE_APB0_PWM,
		.end   = SOCLE_APB0_PWM + SZ_4K -1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_PWM0,
...
static struct resource socle_i2c_0_resources[] = {
	[0] = {
		.start = SOCLE_APB0_I2C,
		.end = SOCLE_APB0_I2C + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_I2C,
...
static struct resource socle_i2c_2_resources[] = {
	[0] = {
		.start = SOCLE_APB0_I2C2,
		.end = SOCLE_APB0_I2C2 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_I2C2,
...
#if (defined(CONFIG_ARCH_P7DK) || defined(CONFIG_ARCH_PDK_PC7210) || defined(CONFIG_ARCH_PDK_PC9220))		//20080109 leonid+ for Panther 7
	.tx_dma_ch = 0,
	.rx_dma_ch = 1,
	.tx_dma_hdreq = 6,
	.rx_dma_hdreq = 7,
...
static struct resource socle_i2s_0_resources[] = {
	[0] = {
		.start = SOCLE_APB0_I2S,
		.end = SOCLE_APB0_I2S + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_I2S,
...
static struct resource socle_udc_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_UDC,
		.end = SOCLE_AHB0_UDC + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_UDC,
...
static struct resource socle_otg_udc_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_OTG,
		.end = SOCLE_AHB0_OTG,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
...
struct platform_device socle_otg_udc_device = {
	.name = "sq_otg_udc",
	.id = 0,
	.dev = {
	...
	.resource = socle_otg_udc_resources,
	.num_resources = ARRAY_SIZE(socle_otg_udc_resources),
};

void __init socle_add_device_otg_udc(void)
{
	platform_device_register(&socle_otg_udc_device);
...
static struct resource ehci_hcd_socle_resource[] = {
	[0] = {
		.start = SOCLE_AHB0_UHC0 + 0x100,
		.end   = SOCLE_AHB0_UHC0 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_UHC0,
...
struct platform_device ehci_hcd_socle_device = {
	.name		  = "SQ EHCI",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(ehci_hcd_socle_resource),
	.resource	  = ehci_hcd_socle_resource,
	.dev              = {
...
static struct resource ehci1_hcd_socle_resource[] = {
	[0] = {
		.start = SOCLE_AHB0_UHC1 + 0x100,
		.end   = SOCLE_AHB0_UHC1 + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_UHC1,
...
static u64 socle_ehci1_dev_usb_dmamask = 0xffffffffUL;

struct platform_device ehci1_hcd_socle_device = {
	.name		  = "SQ EHCI",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(ehci1_hcd_socle_resource),
	.resource	  = ehci1_hcd_socle_resource,
	.dev              = {
		.dma_mask = &socle_ehci1_dev_usb_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}	
};
...
void __init socle_add_device_ehci(void)
{
	...
	platform_device_register(&ehci_hcd_socle_device);
}
#else
void __init socle_add_device_ehci(void) {}
#endif
...
static struct resource ohci_hcd_socle_resource[] = {
	[0] = {
		.start = SOCLE_AHB0_UHC0,
		.end   = SOCLE_AHB0_UHC0 + 0x100 - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_UHC0,
...
static struct resource ohci1_hcd_socle_resource[] = {
	[0] = {
		.start = SOCLE_AHB0_UHC1,
		.end   = SOCLE_AHB0_UHC1 + 0x100 - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_UHC1,
...
static struct resource socle_mac0_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_MAC0,
		.end = SOCLE_AHB0_MAC0 + SZ_16K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_MAC0,
...
static struct resource socle_mac1_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_MAC1,
		.end = SOCLE_AHB0_MAC1 + SZ_16K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_MAC1,
...
static struct resource socle_nand_resources[] = {
	{
		.start	= SOCLE_AHB0_NAND,
		.end	= SOCLE_AHB0_NAND + SZ_64M - 1,
		.flags	= IORESOURCE_MEM,
	}
};
...
#if (defined(CONFIG_ARCH_CDK) || defined(CONFIG_ARCH_PDK_PC9002) || defined(CONFIG_ARCH_SCDK))
	socle_scu_dev_enable(GPIO_NAND_SW);
#endif
...
{
#ifdef CONFIG_ARCH_PDK_PC9220
	socle_scu_dev_enable(SOCLE_DEVCON_WDT);
#endif
...
static struct resource socle_vop_resources[] = {
	[0] = {
		.start = SOCLE_AHB0_VOP,
		.end = SOCLE_AHB0_VOP + SZ_4K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_VOP,
...
extern void
socle_platform_gpio_irq_init(struct socle_gpio_s *socle_gpio)
{
	memset(&socle_gpio[0], 0, sizeof(struct socle_gpio_s));
	socle_gpio[0].base = IO_ADDRESS(SOCLE_APB0_GPIO0);
#if SOCLE_GPIO_GP1 == 1
	memset(&socle_gpio[1], 0, sizeof(struct socle_gpio_s));
	socle_gpio[1].base = IO_ADDRESS(SOCLE_APB0_GPIO1);
#endif
#if SOCLE_GPIO_GP2 == 1
	memset(&socle_gpio[2], 0, sizeof(struct socle_gpio_s));
	socle_gpio[2].base = IO_ADDRESS(SOCLE_APB0_GPIO2);
#endif

#if SOCLE_GPIO_GP3 == 1
	memset(&socle_gpio[3], 0, sizeof(struct socle_gpio_s));
	socle_gpio[3].base = IO_ADDRESS(SOCLE_APB0_GPIO3);
#endif


#ifdef SOCLE_GPIO_WITH_INT

	socle_gpio[0].name = "GPIO INT Service 0";
	socle_gpio[0].irq = IRQ_GPIO0;

#if SOCLE_GPIO_GP1 == 1
	socle_gpio[1].name = "GPIO INT Service 1";
	socle_gpio[1].irq = IRQ_GPIO1;
#endif

#if SOCLE_GPIO_GP2 == 1
	socle_gpio[2].name = "GPIO INT Service 2";
	socle_gpio[2].irq = IRQ_GPIO2;
#endif

#if SOCLE_GPIO_GP3 == 1
	socle_gpio[3].name = "GPIO INT Service 3";
	socle_gpio[3].irq = IRQ_GPIO3;
#endif
...
static struct resource socle_sdhc_slave_resource[] = {
	[0] = {
		.start = SOCLE_AHB0_SDCS,
		.end   = SOCLE_AHB0_SDCS + SZ_128K - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_SDCS,
